...
while True:
    ...
    # Draw a circle showing the part that was detected. The list thing
    # is used to stabilise the readings a little bit. Ask Tony Bhaiya.
    list_cx.append(cx)
    list_cy.append(cy)
    cv2.circle(frame, (mode(list_cx),mode(list_cy)),
               1, (0, 255, 0), 3)
